...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
      ...
      $query = "INSERT INTO ORDERS (id, food_title, price,  quantity, order_date, username, category_id) 
              VALUES ('" . $id . "','" . $food_title . "','" . $price . "','" . $quantity . "','" . $order_date . "','" . $username . "','" . $category_id . "')";
...
//     $query = "INSERT INTO tbl_order (id, food, price,  qty, total, order_date, status, customer_name, customer_contact, Customer_email, customer_address)
//              VALUES ('" . $id . "','" . $food . "','" . $price . "','" . $qty . "','" .$total ."','" . $order_date . "','" .$status ."','" . $customer_name . "','" . $customer_contact . "','" . $customer_email . "','" . $customer_address. "')";
      ...
      if(!$success)
      {
        ...
        <div class="container">
          <div class="jumbotron">
            <h3>Choose way you want to have your meal</h3>
