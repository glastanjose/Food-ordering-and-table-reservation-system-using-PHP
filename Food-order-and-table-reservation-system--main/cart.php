...
<td>Rs.<?php echo $ppu=$row['ItemPrice']?></td>
...
<th style="text-align:center;">Rs.<?php echo $grandtotal;?></th>
<th></th>
</tr>
</thead>
<form method="post">
...
<td colspan="3">
<input type="text" name="Reservation" placeholder="Reservation" class="form-control">
</tr>
<tr>
    <td colspan="3">
